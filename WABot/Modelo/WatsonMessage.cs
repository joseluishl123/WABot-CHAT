...
namespace WatsonAssistant.Models
{
    ...
    public partial class WatsonMessage
    {
        public static WatsonMessage FromJson(string json) => JsonConvert.DeserializeObject<WatsonMessage>(json, Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this WatsonMessage self) => JsonConvert.SerializeObject(self, Models.Converter.Settings);
    }
